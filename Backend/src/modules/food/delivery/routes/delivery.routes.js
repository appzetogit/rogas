...
router.patch('/location', authMiddleware, requireRoles('DELIVERY_PARTNER'), updateLocationController);
...
router.post('/shift-request', authMiddleware, requireRoles('DELIVERY_PARTNER'), createShiftChangeRequestController);
router.get('/shift-request/active', authMiddleware, requireRoles('DELIVERY_PARTNER'), getActiveShiftChangeRequestController);
...
router.get('/dashboard-stats', authMiddleware, requireRoles('DELIVERY_PARTNER'), getDashboardStatsController);
...
router.get('/ratings', authMiddleware, requireRoles('DELIVERY_PARTNER'), getRatingsController);
router.get('/tips', authMiddleware, requireRoles('DELIVERY_PARTNER'), getTipsController);
