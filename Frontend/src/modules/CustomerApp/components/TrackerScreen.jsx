...
export function TrackerScreen({ onGoBack, onShowNotificationToast, tomorrowMeal }) {
  ...
  return (<div className="relative w-full h-[844px] overflow-hidden bg-[#242f3e] shadow-2xl flex flex-col mx-auto rounded-[32px] border-4 border-on-surface">
          ...
          <div className="bg-white rounded-2xl p-3 flex items-center justify-between shadow-lg border border-[#bec9c3]/20">
            ...
            <div className="flex flex-col items-end">
              <div className="bg-primary-container px-2 py-0.5 rounded-full mb-0.5">
                <span className="text-[10px] font-bold text-white uppercase tracking-wider">12:47</span>
              </div>
              <span className="text-[10px] font-extrabold text-on-surface-variant">
                ~{arrivingMin} min away
              </span>
            </div>
          </div>
        </div>
