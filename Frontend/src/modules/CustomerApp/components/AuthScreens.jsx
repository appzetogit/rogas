    ...
    <div className="min-h-screen flex flex-col bg-[#F9F9F9] text-on-surface">
      ...
      <main className="px-5 flex-1 flex flex-col items-center pt-8">
        ...
        <p className="text-[13px] text-on-surface-variant text-center px-4 mb-8 leading-relaxed">
          Enter the 4-digit code sent to <span className="text-[#1F7A63] font-semibold">+48 {phone || "000 000 000"}</span>
        </p>
        ...
        <div className="flex gap-4 mb-6">
          {otp.map((digit, i) => (
            <input
              ...
              className="w-14 h-14 bg-white border border-[#bec9c3] rounded-2xl text-center text-xl font-bold text-[#1F7A63] shadow-sm focus:outline-none focus:border-[#1F7A63] focus:ring-1 focus:ring-[#1F7A63] transition-all"
            />
          ))}
        </div>

        <p className="text-[12px] text-[#6e7a74] mb-10">
          Hint: Try <span className="font-bold text-[#1F7A63]">1234</span>
        </p>
