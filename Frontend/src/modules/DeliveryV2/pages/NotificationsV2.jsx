    ...
    <div className="min-h-screen bg-white flex flex-col">
      <div className="px-4 pt-4 pb-3 flex items-center gap-3 border-b border-gray-200">
        ...
        <div className="flex items-center gap-2 flex-1">
          ...
          <h1 className="text-base font-semibold text-[#2B2B2B]">{t("Notifications")}</h1>
          {unreadCount > 0 && (
      ...
      <div className="flex-1 px-4 pt-4 pb-28">
        {broadcastLoading ? (
          <div className="text-center text-sm text-gray-600 py-12">{t("Loading notifications...")}</div>
        ) : mergedNotifications.length === 0 ? (
          <div className="text-center text-sm text-gray-600 py-12">{t("No notifications")}</div>
        ) : (
            ...
            {mergedNotifications.map((item) => (
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-gray-700 mt-0.5">{item.message || t("Delivery notification")}</p>
