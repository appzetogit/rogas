...
export default function RestaurantWithdraws() {
  ...
  const handleExport = async (format) => {
    ...
    const headers = [
      ...
      { key: "restaurantName", label: "Vendor Name" },
      { key: "restaurantIdString", label: "Vendor ID" },
    ...
    switch (format) {
      case "excel":
        exportTransactionsToExcel(exportData, headers, "vendor_withdraws_full_details")
        break
      case "pdf":
        await exportTransactionsToPDF(exportData, headers, "vendor_withdraws_full_details", "Vendor Withdraws Report")
        break
      default: break
    }
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-slate-900">Vendor Withdraw Transaction</h1>
          </div>
        </div>
              ...
              <table className="w-full">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr>
                    ...
                    {visibleColumns.restaurant && <th className="px-6 py-4 text-left text-[10px] font-bold text-slate-700 uppercase tracking-wider">Vendor Name</th>}
                    {visibleColumns.restaurantId && <th className="px-6 py-4 text-left text-[10px] font-bold text-slate-700 uppercase tracking-wider">Vendor ID</th>}
