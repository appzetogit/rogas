...
const VendorEarnings = lazy(() => import("@food/pages/admin/transactions/VendorEarnings"));
...
const RolesPermissions = lazy(() => import("@food/pages/admin/employees/RolesPermissions"));
